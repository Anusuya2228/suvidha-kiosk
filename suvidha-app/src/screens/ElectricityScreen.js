...
export default function ElectricityScreen({ navigate, language }) {
  const [action, setAction] = useState(null); // null, "bill", "complaint"

  // Mock bill data
  const bill = {
    consumerName: "Anusuya G",
    consumerId: "TN123456789",
    units: 245,
    amount: 1840,
  ...
  if (action === "bill") {
    return <BillView bill={bill} navigate={navigate} setAction={setAction} />;
  }
  ...
  return (
    <div style={styles.container}>
      <div style={styles.header}>
        ...
        <h1 style={styles.title}>⚡ Electricity Services</h1>
      ...
      <div style={styles.grid}>
        ...
        <div style={styles.card} onClick={() => navigate("complaint")}>
          ...
          <p style={styles.cardDesc}>Report outage, meter fault, billing issue</p>
        </div>

        <div style={styles.card} onClick={() => navigate("success")}>
          <span style={styles.icon}>🔌</span>
          <h2 style={styles.cardTitle}>New Connection</h2>
          <p style={styles.cardDesc}>Apply for a new electricity connection</p>
        </div>
...
// Bill View Component
function BillView({ bill, navigate, setAction }) {
  ...
  return (
    <div style={styles.container}>
      <div style={styles.header}>
        ...
        <h1 style={styles.title}>📄 Your Electricity Bill</h1>
      </div>
      ...
      <div style={styles.billCard}>
        ...
        <div style={styles.billRow}>
          <span style={styles.billLabel}>Units Consumed</span>
          <span style={styles.billValue}>{bill.units} kWh</span>
        </div>
        <div style={styles.billRow}>
      ...
      <div style={styles.payGrid}>
        {["UPI", "Card", "Net Banking", "Wallet"].map((m) => (
          <button
            ...
            style={{
              ...styles.payBtn,
              background: method === m ? "#1a237e" : "white",
              color: method === m ? "white" : "#1a237e",
            }}
            onClick={() => handlePay(m)}
          >
            {m === "UPI" && "📱 "}
